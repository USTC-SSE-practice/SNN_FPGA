...
using hls::sim::Byte;
extern "C" void snn_infer(Byte<4>*, Byte<4>*);
extern "C" void apatb_snn_infer_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  snn_infer(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
